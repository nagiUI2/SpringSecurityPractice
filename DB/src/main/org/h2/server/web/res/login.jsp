...
-->
    ...
    &nbsp;&nbsp; <a href="help.jsp?jsessionid=${sessionId}">${text.a.help}</a>
        ...
        <table class="login" cellspacing="0" cellpadding="0">
            ...
            <tr class="login">
                <td class="login">${text.a.userEntity}:</td>
                <td class="login"><input type="text" name="userEntity" value="${userEntity}" style="width:200px;" /></td>
            </tr>
            <tr class="login">
        ...
        <div id="url" style="display: none">
            ...
            the userEntity home directory in files starting with 'test'.
            ...
            called test in the userEntity home directory. The server must be started first.
