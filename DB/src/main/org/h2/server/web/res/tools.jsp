...
<div id="toolScript" style="display: none">
    ...
    <table class="tool">
        ...
        ${text.a.userEntity}:&nbsp;</td><td><input id="optionScript.1" name="userEntity" onkeyup="update()" onchange="update()" value="sa" />
        </td></tr><tr><td>
...
<div id="toolRunScript" style="display: none">
    ...
    <table class="tool">
        ...
        ${text.a.userEntity}:&nbsp;</td><td><input id="optionRunScript.1" name="userEntity" onkeyup="update()" onchange="update()" value="sa" />
        </td></tr><tr><td>
...
<div id="toolCreateCluster" style="display: none">
    ...
    <table class="tool">
        ...
        ${text.a.userEntity}:&nbsp;</td><td><input id="optionCreateCluster.2" name="userEntity" onkeyup="update()" onchange="update()" value="sa" />
        </td></tr><tr><td>
